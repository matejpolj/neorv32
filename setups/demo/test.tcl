...
if {$make_assignments} {
  ...
  set_location_assignment PIN_E1 -to gpio_i[4]
  set_location_assignment PIN_M15 -to gpio_i[3]
  set_location_assignment PIN_B9 -to gpio_i[2]
  set_location_assignment PIN_T8 -to gpio_i[1]
  set_location_assignment PIN_M1 -to gpio_i[0]
  ...
  set_location_assignment GPIO_15 -to uart0_txd_o
  set_location_assignment GPIO_14 -to uart0_rxd_i
  set_location_assignment GPIO_21 -to setup0
  set_location_assignment GPIO_22 -to setup1
